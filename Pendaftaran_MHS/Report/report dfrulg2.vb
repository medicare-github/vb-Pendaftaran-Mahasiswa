...
Public Class report_dfrulg2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pendaftaran_MHS.report dfrulg2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_dfrulg2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_dfrulg2 = New report_dfrulg2()
        rpt.Site = Me.Site
        Return rpt
    End Function
