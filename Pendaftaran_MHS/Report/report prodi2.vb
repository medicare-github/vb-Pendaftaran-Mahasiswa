...
Public Class report_prodi2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pendaftaran_MHS.report prodi2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_prodi2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_prodi2 = New report_prodi2()
        rpt.Site = Me.Site
        Return rpt
    End Function
