...
Public Class report_panitia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pendaftaran_MHS.report panitia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_panitia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_panitia = New report_panitia()
        rpt.Site = Me.Site
        Return rpt
    End Function
